using CursoCsharp.section_17.LINQ.LINQeLambda.Entities;
using System;
...
namespace CursoCsharp.section_17.LINQ.LINQeLambda
{
    internal class LINQeLambdaMain
    {
        ...
        static void Main(string[] args)
        {
            ...
            Print("Names of Produts from TOOLS", r2);
